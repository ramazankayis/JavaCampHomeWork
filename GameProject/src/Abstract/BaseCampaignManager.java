...
public abstract class BaseCampaignManager implements CampaignService {
	...
	public void campaignAdd(Games games, Customer customer) {
		System.out.println(games.getGameName() + " oyunu " + customer.getFirstName() + "tarafından % "
	...
	public void campaignDelete(Games games, Customer customer) {
		System.out.println(games.getGameName() + " oyununun indirimine" + customer.getFirstName()
				+ " kişisi tarafından son verildi ");
	}
}
